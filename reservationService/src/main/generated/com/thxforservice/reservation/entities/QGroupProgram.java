...
public class QGroupProgram extends EntityPathBase<GroupProgram> {
    ...
    private static final long serialVersionUID = -154696699L;
    ...
    public final EnumPath<com.thxforservice.reservation.constants.ProgramStatus> status = createEnum("status", com.thxforservice.reservation.constants.ProgramStatus.class);
